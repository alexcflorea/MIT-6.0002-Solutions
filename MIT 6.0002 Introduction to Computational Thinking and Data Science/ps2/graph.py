...
class Edge(object):
    ...
    def __init__(self, src, dest):
        self.src = src      #These are node objects
        self.dest = dest
...
class WeightedEdge(Edge):
    def __init__(self, src, dest, total_distance, outdoor_distance):
        Edge.__init__(self, src, dest)      #Node objects
        self.td = total_distance            #Int
        self.od = outdoor_distance          #Int
    ...
    def __str__(self):
        return '{}->{} ({}, {})'.format(self.src, self.dest, self.td, self.od)
